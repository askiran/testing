  ...
  <body>
    ...
    <div class="main-nav-wrapper">
       <nav class="container">
           <ul class="main-nav clearfix">
               ...
               <li class="active"><a href="">company projects</a></li>
    ...
    <table class="table table-striped">
      ...
      <tbody>
          ...
          <td><a href="editAcademicProject.php?idcompanyproject=<?php echo $companyArray[$i]['idcompanyproject'];?>" class="icon icon--edit" >Edit</a></td>
        </tr> 
